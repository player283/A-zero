...
<div class="main">
	<section class="module bg-dark-60 shop-page-header" data-background="/images/zero/background1.jpg">
		<div class="container">
			<div class="row">
									...
									<td>
										<div class="media">
											<div class="d-flex">
												...
												<a href="/board/productDetail?product_id=${cartList.product.product_id}">${cartList.product.product_name}</a>
											</div>
										</div>
									</td>
									<td>
