...
import com.sam.zero.mappers.BoardMapper;
...
public class BoardServiceImpl implements BoardService {
	...
	public int getQnaBoardReplyCount(Long board_re_ref) {
		return boardMapper.getQnaBoardReplyCount(board_re_ref);
	}

	@Override
	public String getQnaBoardParentMemeberId(Long board_re_ref) {
		return boardMapper.getQnaBoardParentMemeberId(board_re_ref);
	}
