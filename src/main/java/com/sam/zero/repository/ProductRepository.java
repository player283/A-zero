package com.sam.zero.repository;
...
import com.sam.zero.domain.Cart;
import com.sam.zero.domain.CartList;
import com.sam.zero.domain.Category;
import com.sam.zero.domain.Order;
import com.sam.zero.domain.OrderDetail;
import com.sam.zero.domain.Product;
import com.sam.zero.domain.Review_Board;
import com.sam.zero.domain.orderProduct;
import com.sam.zero.mappers.ProductMapper;
...
public class ProductRepository {
	...
	//상품전체조회
		...
		public List<Product> searchList(HashMap<String, Object> hm){
			return productMapper.searchList(hm);
		}
		//상품조회
